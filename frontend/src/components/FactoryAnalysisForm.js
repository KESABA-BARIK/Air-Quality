...
import './FactoryAnalysisForm.css'; // Make sure to create this CSS file
                ...
                <div className="result-container fade-in">
                    ...
                    <div className="result-grid">
                        ...
                        <div className="result-item">
                            ...
                            <span className={`alert-status ${getAlertColorClass(result.alert)}`}>
                        ...
                        {recentAnalyses.map((analysis, index) => (
                            <div key={index} className="analysis-card">
                                <div className="card-header">
                                    ...
                                    <span className={`status-badge ${getAlertColorClass(analysis.alert)}`}>
